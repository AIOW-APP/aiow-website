...
export async function generateQuotePdf({ quoteNumber, snapshot, contact }) {
  ...
  text(en ? `Book the free AI opportunity scan: ${snapshot.bookingUrl}` : `Plan de gratis AI-kansenscan: ${snapshot.bookingUrl}`, { font: helveticaBold, size: 10, leading: 14, color: COPPER });
