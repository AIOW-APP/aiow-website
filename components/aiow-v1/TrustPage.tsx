...
type Locale = "nl" | "en";
const facts = { legalName: "AIOW B.V.", kvk: "71887466", email: "info@aiow.io", street: "Bijlmermeerstraat 30", postalCode: "2131 HC", location: "Hoofddorp", serviceArea: "Nederland" } as const;
