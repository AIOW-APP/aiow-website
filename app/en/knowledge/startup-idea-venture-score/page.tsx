...
export const metadata = pageMetadata({ title: "Assess a startup idea with a venture score", description: "How AIOW evaluates founder, market, problem, AI leverage, traction, buildability and deal quality with a human decision gate.", path, pairedPaths: { nl: "/nl/kennis/startup-idee-laten-beoordelen-venture-score", en: path }, locale: "en" });
const schemas = [
  { "@context": "https://schema.org", "@type": "Article", headline: "Assess a startup idea with a venture score", description: "Seven dimensions, counter-evidence and a mandatory human decision gate.", inLanguage: "en-GB", datePublished: "2026-08-31", dateModified: "2026-08-31", mainEntityOfPage: `${SITE_URL}${path}`, author: { "@type": "Organization", "@id": `${SITE_URL}/#organization`, name: "AIOW B.V.", url: SITE_URL }, publisher: { "@type": "Organization", "@id": `${SITE_URL}/#organization`, name: "AIOW B.V.", url: SITE_URL } },
