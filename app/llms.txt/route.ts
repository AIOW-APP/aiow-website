    ...
    keyPages: [
      {
        ...
        links: [
          ...
          { title: "Bureau versus venture partner selectie", url: `${SITE_URL}/nl/kennis/waarom-bureaus-vaker-ja-zeggen-en-venture-partners-selecteren`, summary: "W5 cornerstone: waarom een betaald bureau meer haalbare opdrachten kan aannemen en een venture partner door gedeeld risico selecteert op founder, markt, bewijs, AI-hefboom en dealkwaliteit." },
          { title: "AI-groeikans in een bestaand MKB-bedrijf herkennen", url: `${SITE_URL}/nl/kennis/ai-groeikans-in-bestaand-mkb-bedrijf-herkennen`, summary: "W6 cornerstone: herken AI-kansen vanuit omzetlekkage, wachttijd, schaars expertwerk en versnipperde kennis; valideer met nulmeting, proceseigenaar, menselijke controle en een begrensde pilot." },
