...
export const metadata = pageMetadata({ title: "Startup-idee laten beoordelen met een venture-score", description: "Hoe AIOW founder, markt, probleem, AI-hefboom, tractie, bouwbaarheid en dealkwaliteit beoordeelt met menselijke beslisgate.", path, pairedPaths: { nl: path, en: "/en/knowledge/startup-idea-venture-score" } });
const schemas = [
