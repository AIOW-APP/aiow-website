...
const sections = [
  ...
  { title: "2. What data do we process?", body: "We only process data that you actively provide, such as name, company name and contact details during an AI system scan, WhatsApp contact or OneTap Day intake, and information about your business processes, tasks, appointments, work windows and priorities that you share during a scan or intake. We do not install analytics, tracking or marketing pixels unless this has been explicitly approved." },
  ...
  { title: "4. Retention", body: "We do not keep data longer than necessary for the purpose for which it was provided, and no longer than required by legal retention obligations. Raw OneTap Day Phase 1 intake is retained for a maximum of 30 days. On request via support@aiow.ai or hello@aiow.ai, we remove it from the active inbox/workflow earlier and queue it for permanent purge according to the mailbox provider's deletion cycle." },
  { title: "5. Sharing with third parties", body: "We do not share personal data with third parties without your consent, except where legally required or necessary to process the communication/service you requested, such as email delivery via Resend (DPA: resend.com/legal/dpa; subprocessors: resend.com/legal/subprocessors). For AI processing we use local or private infrastructure where possible. For OneTap Day you separately consent that AIOW may use AI tools to summarise your text-only intake and produce a day plan. Do not submit passwords, secrets, medical details, financial account data or sensitive third-party data." },
